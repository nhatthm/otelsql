module github.com/nhatthm/otelsql/tests/mssql
...
require (
	...
	go.nhat.io/testcontainers-registry/mssql v0.2.0
)
...
require (
	...
	github.com/bool64/ctxd v1.1.3 // indirect
	...
	github.com/godogx/clocksteps v0.2.0 // indirect
